...
export class RayMarchSDF2Material extends ShaderMaterial {
			...
			fragmentShader: /* glsl */`
				...
				void main() {
					...
					// if ( intersectsBox ) {
    					...
    					float rayDist;
    					vec3 outPoint;
    					float distanceToSurface = bvhClosestPointToPoint( bvh, (matrix * vec4(uv - vec3( 0.5 ), 1.0)).xyz, 100000.0, faceIndices, faceNormal, barycoord, side, outPoint );
    					distanceToSurface *= side;
						...
						if ( intersectsSurface ) {
							...
							float lightIntensity =
								...
								0.1;
							gl_FragColor.rg = vec2( lightIntensity );
							gl_FragColor.a = 1.0;
